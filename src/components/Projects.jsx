...
const projects = [
  ...
  },
  {
    ...
    description: "Ai Fitness Trainer made for SIH",
  ...
  {
    title: "Weather App",
    description: "Android weather app with real-time weather updates.",
    liveDemo: "https://project3-demo.com",
    code: "",
    image: "/placeholder.svg?height=200&width=300",
  },
  {
    title: "Dodge the creep 2D game",
    description: "2D game where you dodge the creep made using Godot",
